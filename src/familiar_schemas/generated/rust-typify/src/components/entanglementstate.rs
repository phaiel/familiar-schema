...
#[doc = "Captures the subjective experience of a Moment by a specific Thread, linking them with quantum properties."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"$id\": \"https://familiar.dev/schemas/components/EntanglementState.v1.schema.json\","]
#[doc = "  \"title\": \"Entanglement State Component\","]
#[doc = "  \"description\": \"Captures the subjective experience of a Moment by a specific Thread, linking them with quantum properties.\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"fields\","]
...
#[doc = "  \"fields\": {"]
#[doc = "    \"instance_details\": {"]
#[doc = "      \"$id\": \"https://familiar.dev/schemas/components/InstanceComponent.v1.schema.json\","]
#[doc = "      \"$schema\": \"https://json-schema.org/draft/2020-12/schema\","]
#[doc = "      \"description\": \"Captures the specific attributes of a generic object within the context of a single event (Entanglement).\","]
#[doc = "      \"fields\": {"]
#[doc = "        \"generic_thread_id\": {"]
...
#[doc = "          \"type\": \"string\""]
#[doc = "        },"]
#[doc = "        \"significance_score\": {"]
#[doc = "          \"default\": 0.5,"]
#[doc = "          \"description\": \"The significance of this specific instance in the event, used by BondModulationLaw.\","]
#[doc = "          \"maximum\": 1.0,"]
#[doc = "          \"minimum\": 0.0,"]
#[doc = "          \"type\": \"number\""]
#[doc = "        },"]
#[doc = "        \"specific_attributes\": {"]
...
#[doc = "  },"]
#[doc = "  \"schema_version\": \"1.0.0\","]
#[doc = "  \"source_file\": \"components/EntanglementState.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct EntanglementStateComponent {
    ...
    pub fields: ::std::collections::HashMap<
        EntanglementStateComponentFieldsKey,
        EntanglementStateComponentFieldsValue,
    >,
    pub physics_properties: BasePhysicsProperties,
}
impl ::std::convert::From<&EntanglementStateComponent> for EntanglementStateComponent {
    fn from(value: &EntanglementStateComponent) -> Self {
        value.clone()
    }
}
impl EntanglementStateComponent {
    pub fn builder() -> builder::EntanglementStateComponent {
        Default::default()
    }
}
#[doc = "`EntanglementStateComponentFieldsKey`"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[serde(transparent)]
pub struct EntanglementStateComponentFieldsKey(::std::string::String);
impl ::std::ops::Deref for EntanglementStateComponentFieldsKey {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<EntanglementStateComponentFieldsKey> for ::std::string::String {
    fn from(value: EntanglementStateComponentFieldsKey) -> Self {
        value.0
    }
}
impl ::std::convert::From<&EntanglementStateComponentFieldsKey>
    for EntanglementStateComponentFieldsKey
{
    fn from(value: &EntanglementStateComponentFieldsKey) -> Self {
        value.clone()
    }
}
impl ::std::str::FromStr for EntanglementStateComponentFieldsKey {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for EntanglementStateComponentFieldsKey {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for EntanglementStateComponentFieldsKey {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for EntanglementStateComponentFieldsKey {
...
#[doc = "`EntanglementStateComponentFieldsValue`"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
pub enum EntanglementStateComponentFieldsValue {
    Variant0 {
        #[serde(rename = "$ref")]
...
impl ::std::convert::From<&Self> for EntanglementStateComponentFieldsValue {
    fn from(value: &EntanglementStateComponentFieldsValue) -> Self {
        value.clone()
    }
}
...
pub mod builder {
    ...
    pub struct EntanglementStateComponent {
        fields: ::std::result::Result<
            ::std::collections::HashMap<
                super::EntanglementStateComponentFieldsKey,
                super::EntanglementStateComponentFieldsValue,
            >,
            ::std::string::String,
        >,
        physics_properties:
    ...
    impl ::std::default::Default for EntanglementStateComponent {
        fn default() -> Self {
            Self {
    ...
    impl ::std::convert::TryFrom<EntanglementStateComponent> for super::EntanglementStateComponent {
        type Error = super::error::ConversionError;
        fn try_from(
            value: EntanglementStateComponent,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                fields: value.fields?,
    ...
    impl ::std::convert::From<super::EntanglementStateComponent> for EntanglementStateComponent {
        fn from(value: super::EntanglementStateComponent) -> Self {
            Self {
