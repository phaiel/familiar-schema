...
#[doc = "A quantum entity representing a high-level, user-declared thematic goal or life chapter."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[doc = "  \"source_file\": \"entities/Focus.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct FocusEntity {
    pub components: FocusComponents,
    #[doc = "A canonical enum of all 7 cognitive entity types."]
    pub entity_type: EntityType,
    pub physics_state: FocusPhysicsState,
}
impl ::std::convert::From<&FocusEntity> for FocusEntity {
    fn from(value: &FocusEntity) -> Self {
        value.clone()
    }
}
impl FocusEntity {
    pub fn builder() -> builder::FocusEntity {
        Default::default()
    }
}
...
pub mod builder {
    ...
    pub struct FocusComponents {
        comment: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        content: ::std::result::Result<::serde_json::Value, ::std::string::String>,
    }
    ...
    #[derive(Clone, Debug)]
    pub struct FocusEntity {
        components: ::std::result::Result<super::FocusComponents, ::std::string::String>,
        entity_type: ::std::result::Result<super::EntityType, ::std::string::String>,
        physics_state: ::std::result::Result<super::FocusPhysicsState, ::std::string::String>,
    }
    impl ::std::default::Default for FocusEntity {
        fn default() -> Self {
            Self {
    ...
    impl FocusEntity {
        ...
        where
            T: ::std::convert::TryInto<super::FocusComponents>,
            T::Error: ::std::fmt::Display,
        {
        ...
        where
            T: ::std::convert::TryInto<super::FocusPhysicsState>,
            T::Error: ::std::fmt::Display,
        {
    ...
    impl ::std::convert::TryFrom<FocusEntity> for super::FocusEntity {
        type Error = super::error::ConversionError;
        fn try_from(
            value: FocusEntity,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::FocusEntity> for FocusEntity {
        fn from(value: super::FocusEntity) -> Self {
            Self {
