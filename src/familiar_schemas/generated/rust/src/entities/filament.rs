...
pub struct FilamentContentComponent {
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub fields: ::std::option::Option<FilamentContentFields>,
}
...
#[doc = "A quantum entity representing a high-level, emergent narrative, belief, or worldview, derived from the analysis of Threads and Bonds."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[doc = "  \"source_file\": \"entities/Filament.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct FilamentEntity {
    pub components: FilamentComponents,
    #[doc = "A canonical enum of all 7 cognitive entity types."]
    pub entity_type: EntityType,
    pub physics_state: FilamentPhysicsState,
}
impl ::std::convert::From<&FilamentEntity> for FilamentEntity {
    fn from(value: &FilamentEntity) -> Self {
        value.clone()
    }
}
impl FilamentEntity {
    pub fn builder() -> builder::FilamentEntity {
        Default::default()
    }
}
...
pub mod builder {
    ...
    pub struct FilamentContentComponent {
        fields: ::std::result::Result<
            ::std::option::Option<super::FilamentContentFields>,
            ::std::string::String,
        >,
    }
    ...
    impl FilamentContentComponent {
        pub fn fields<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::FilamentContentFields>>,
            T::Error: ::std::fmt::Display,
        {
            self.fields = value
                .try_into()
    ...
    #[derive(Clone, Debug)]
    pub struct FilamentEntity {
        components: ::std::result::Result<super::FilamentComponents, ::std::string::String>,
        entity_type: ::std::result::Result<super::EntityType, ::std::string::String>,
        physics_state: ::std::result::Result<super::FilamentPhysicsState, ::std::string::String>,
    }
    impl ::std::default::Default for FilamentEntity {
        fn default() -> Self {
            Self {
    ...
    impl FilamentEntity {
        ...
        where
            T: ::std::convert::TryInto<super::FilamentComponents>,
            T::Error: ::std::fmt::Display,
        {
        ...
        where
            T: ::std::convert::TryInto<super::FilamentPhysicsState>,
            T::Error: ::std::fmt::Display,
        {
    ...
    impl ::std::convert::TryFrom<FilamentEntity> for super::FilamentEntity {
        type Error = super::error::ConversionError;
        fn try_from(
            value: FilamentEntity,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
    ...
    impl ::std::convert::From<super::FilamentEntity> for FilamentEntity {
        fn from(value: super::FilamentEntity) -> Self {
            Self {
