...
#[doc = "A 2x2 matrix of complex numbers representing a quantum state."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[doc = "  \"source_file\": \"snippets/types/physics/DensityMatrix.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
#[serde(transparent)]
pub struct DensityMatrix(pub [[ComplexNumber; 2usize]; 2usize]);
impl ::std::ops::Deref for DensityMatrix {
    type Target = [[ComplexNumber; 2usize]; 2usize];
    fn deref(&self) -> &[[ComplexNumber; 2usize]; 2usize] {
        &self.0
    }
}
impl ::std::convert::From<DensityMatrix> for [[ComplexNumber; 2usize]; 2usize] {
    fn from(value: DensityMatrix) -> Self {
        value.0
    }
}
impl ::std::convert::From<&DensityMatrix> for DensityMatrix {
    fn from(value: &DensityMatrix) -> Self {
        value.clone()
    }
}
impl ::std::convert::From<[[ComplexNumber; 2usize]; 2usize]> for DensityMatrix {
    fn from(value: [[ComplexNumber; 2usize]; 2usize]) -> Self {
        Self(value)
    }
}
