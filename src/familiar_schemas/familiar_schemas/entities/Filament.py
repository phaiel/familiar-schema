...
#   filename:  tmpmfwuy7dh.json
#   timestamp: 2025-06-21T04:00:29+00:00
...
class Content(BaseModel):
    ...
    fields: Annotated[Fields | None, Field(title='FilamentContentFields')]
...
class Filament(BaseModel):
    ...
    physics_state: Annotated[PhysicsState, Field(title='FilamentPhysicsState')]
