...
#   filename:  tmpif6nt94z.json
#   timestamp: 2025-06-21T04:00:32+00:00
...
class GenericThread(BaseModel):
    ...
    physics_state: Annotated[PhysicsState, Field(title='GenericThreadPhysicsState')]
