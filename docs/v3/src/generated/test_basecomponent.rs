...
#[doc = "The base schema for all ECS components."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"$id\": \"https://familiar.dev/schemas/base/Component.v1.schema.json\","]
#[doc = "  \"title\": \"Base Component\","]
#[doc = "  \"description\": \"The base schema for all ECS components.\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"description\","]
#[doc = "    \"fields\","]
...
#[doc = "  },"]
#[doc = "  \"category\": \"_base\","]
#[doc = "  \"source_file\": \"_base/BaseComponent.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
...
pub struct BaseComponent {
    ...
    pub fields: ::std::collections::HashMap<BaseComponentFieldsKey, BaseComponentFieldsValue>,
...
impl ::std::convert::From<&BaseComponent> for BaseComponent {
    fn from(value: &BaseComponent) -> Self {
        value.clone()
    }
}
impl BaseComponent {
    pub fn builder() -> builder::BaseComponent {
        Default::default()
    }
}
#[doc = "`BaseComponentFieldsKey`"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[serde(transparent)]
pub struct BaseComponentFieldsKey(::std::string::String);
impl ::std::ops::Deref for BaseComponentFieldsKey {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<BaseComponentFieldsKey> for ::std::string::String {
    fn from(value: BaseComponentFieldsKey) -> Self {
        value.0
    }
}
impl ::std::convert::From<&BaseComponentFieldsKey> for BaseComponentFieldsKey {
    fn from(value: &BaseComponentFieldsKey) -> Self {
        value.clone()
    }
}
impl ::std::str::FromStr for BaseComponentFieldsKey {
...
impl ::std::convert::TryFrom<&str> for BaseComponentFieldsKey {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for BaseComponentFieldsKey {
    type Error = self::error::ConversionError;
    fn try_from(
...
impl<'de> ::serde::Deserialize<'de> for BaseComponentFieldsKey {
...
pub enum BaseComponentFieldsValue {
    Variant0 {
        #[serde(rename = "$ref")]
...
impl ::std::convert::From<&Self> for BaseComponentFieldsValue {
    fn from(value: &BaseComponentFieldsValue) -> Self {
        value.clone()
    }
}
...
pub mod builder {
    ...
    pub struct BaseComponent {
        ...
        fields: ::std::result::Result<
            ::std::collections::HashMap<
                super::BaseComponentFieldsKey,
                super::BaseComponentFieldsValue,
            >,
            ::std::string::String,
        >,
        physics_properties:
    ...
    impl ::std::default::Default for BaseComponent {
        fn default() -> Self {
            Self {
    ...
    impl ::std::convert::TryFrom<BaseComponent> for super::BaseComponent {
    ...
    impl ::std::convert::From<super::BaseComponent> for BaseComponent {
        fn from(value: super::BaseComponent) -> Self {
            Self {
