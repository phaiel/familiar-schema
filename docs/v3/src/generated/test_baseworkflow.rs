...
#[doc = "The base schema for defining a Windmill DAG."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"$id\": \"https://familiar.dev/schemas/base/Workflow.v1.schema.json\","]
#[doc = "  \"title\": \"Base Workflow (DAG)\","]
#[doc = "  \"description\": \"The base schema for defining a Windmill DAG.\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"description\","]
#[doc = "    \"schema_version\","]
...
#[doc = "  },"]
#[doc = "  \"category\": \"_base\","]
#[doc = "  \"source_file\": \"_base/BaseWorkflow.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct BaseWorkflowDag {
...
impl ::std::convert::From<&BaseWorkflowDag> for BaseWorkflowDag {
    fn from(value: &BaseWorkflowDag) -> Self {
        value.clone()
    }
}
impl BaseWorkflowDag {
    pub fn builder() -> builder::BaseWorkflowDag {
        Default::default()
    }
}
...
pub mod builder {
    ...
    impl ::std::default::Default for BaseWorkflowDag {
        fn default() -> Self {
            Self {
    ...
    impl ::std::convert::TryFrom<BaseWorkflowDag> for super::BaseWorkflowDag {
        type Error = super::error::ConversionError;
        fn try_from(
            value: BaseWorkflowDag,
    ...
    impl ::std::convert::From<super::BaseWorkflowDag> for BaseWorkflowDag {
        fn from(value: super::BaseWorkflowDag) -> Self {
            Self {
