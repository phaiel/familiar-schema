...
#[doc = "A Thread representing a person, which MUST have a CognitiveBaseline."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[doc = "  \"source_file\": \"entities/PersonThread.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct PersonThread {
    pub components: PersonThreadComponents,
    ...
    pub physics_state: PersonThreadPhysicsState,
    #[doc = "A canonical definition for a Universally Unique Identifier (UUID)."]
    pub tenant_id: ::std::string::String,
}
impl ::std::convert::From<&PersonThread> for PersonThread {
    fn from(value: &PersonThread) -> Self {
        value.clone()
    }
}
impl PersonThread {
    pub fn builder() -> builder::PersonThread {
        Default::default()
    }
}
...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct PersonThread {
        components: ::std::result::Result<super::PersonThreadComponents, ::std::string::String>,
        ...
        physics_state:
            ::std::result::Result<super::PersonThreadPhysicsState, ::std::string::String>,
        tenant_id: ::std::result::Result<::std::string::String, ::std::string::String>,
    }
    impl ::std::default::Default for PersonThread {
        fn default() -> Self {
            Self {
    ...
    impl PersonThread {
        ...
        where
            T: ::std::convert::TryInto<super::PersonThreadComponents>,
            T::Error: ::std::fmt::Display,
        {
        ...
        where
            T: ::std::convert::TryInto<super::PersonThreadPhysicsState>,
            T::Error: ::std::fmt::Display,
        {
    ...
    impl ::std::convert::TryFrom<PersonThread> for super::PersonThread {
        type Error = super::error::ConversionError;
        fn try_from(
            value: PersonThread,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::PersonThread> for PersonThread {
        fn from(value: super::PersonThread) -> Self {
            Self {
