...
#[doc = "Captures the specific attributes of a generic object within the context of a single event (Entanglement)."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[doc = "  \"source_file\": \"components/InstanceComponent.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct InstanceComponent {
    ...
    pub fields:
        ::std::collections::HashMap<InstanceComponentFieldsKey, InstanceComponentFieldsValue>,
    pub physics_properties: BasePhysicsProperties,
}
impl ::std::convert::From<&InstanceComponent> for InstanceComponent {
    fn from(value: &InstanceComponent) -> Self {
        value.clone()
    }
}
impl InstanceComponent {
    pub fn builder() -> builder::InstanceComponent {
        Default::default()
    }
}
#[doc = "`InstanceComponentFieldsKey`"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[serde(transparent)]
pub struct InstanceComponentFieldsKey(::std::string::String);
impl ::std::ops::Deref for InstanceComponentFieldsKey {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<InstanceComponentFieldsKey> for ::std::string::String {
    fn from(value: InstanceComponentFieldsKey) -> Self {
        value.0
    }
}
impl ::std::convert::From<&InstanceComponentFieldsKey> for InstanceComponentFieldsKey {
    fn from(value: &InstanceComponentFieldsKey) -> Self {
        value.clone()
    }
}
impl ::std::str::FromStr for InstanceComponentFieldsKey {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for InstanceComponentFieldsKey {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for InstanceComponentFieldsKey {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for InstanceComponentFieldsKey {
...
#[doc = "`InstanceComponentFieldsValue`"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
pub enum InstanceComponentFieldsValue {
    Variant0 {
        #[serde(rename = "$ref")]
...
impl ::std::convert::From<&Self> for InstanceComponentFieldsValue {
    fn from(value: &InstanceComponentFieldsValue) -> Self {
        value.clone()
    }
}
...
pub mod builder {
    ...
    pub struct InstanceComponent {
        fields: ::std::result::Result<
            ::std::collections::HashMap<
                super::InstanceComponentFieldsKey,
                super::InstanceComponentFieldsValue,
            >,
            ::std::string::String,
        >,
        physics_properties:
    ...
    impl ::std::default::Default for InstanceComponent {
        fn default() -> Self {
            Self {
    ...
    impl ::std::convert::TryFrom<InstanceComponent> for super::InstanceComponent {
        type Error = super::error::ConversionError;
        fn try_from(
    ...
    impl ::std::convert::From<super::InstanceComponent> for InstanceComponent {
        fn from(value: super::InstanceComponent) -> Self {
            Self {
