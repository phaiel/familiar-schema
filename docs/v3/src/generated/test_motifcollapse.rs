...
#[doc = "Performs a quantum measurement on a Motif entity, collapsing its superposition into a single classical state. This is a high-priority, user-responsive law."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"$id\": \"https://familiar.dev/schemas/laws/MotifCollapse.v1.schema.json\","]
#[doc = "  \"title\": \"Motif Collapse Law\","]
#[doc = "  \"description\": \"Performs a quantum measurement on a Motif entity, collapsing its superposition into a single classical state. This is a high-priority, user-responsive law.\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
...
#[doc = "  },"]
#[doc = "  \"affected_components\": ["]
#[doc = "    \"https://familiar.dev/schemas/components/QuantumState.v1.schema.json\","]
...
#[doc = "    \"priority\": 2,"]
#[doc = "    \"timeout_ms\": 200,"]
#[doc = "    \"trigger\": \"observation\""]
#[doc = "  },"]
#[doc = "  \"physics_properties\": {"]
#[doc = "    \"collapse_sensitive\": true,"]
#[doc = "    \"engine\": \"quantum\","]
#[doc = "    \"is_quantum\": true"]
#[doc = "  },"]
#[doc = "  \"schema_version\": \"1.0.0\","]
#[doc = "  \"source_file\": \"laws/MotifCollapse.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct MotifCollapseLaw {
...
impl ::std::convert::From<&MotifCollapseLaw> for MotifCollapseLaw {
    fn from(value: &MotifCollapseLaw) -> Self {
        value.clone()
    }
}
impl MotifCollapseLaw {
    pub fn builder() -> builder::MotifCollapseLaw {
        Default::default()
    }
}
...
pub mod builder {
    ...
    impl ::std::default::Default for MotifCollapseLaw {
        fn default() -> Self {
            Self {
    ...
    impl ::std::convert::TryFrom<MotifCollapseLaw> for super::MotifCollapseLaw {
        type Error = super::error::ConversionError;
        fn try_from(
            value: MotifCollapseLaw,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
    ...
    impl ::std::convert::From<super::MotifCollapseLaw> for MotifCollapseLaw {
        fn from(value: super::MotifCollapseLaw) -> Self {
            Self {
