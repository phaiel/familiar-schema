...
#[doc = "A classical entity representing a specific, user-declared future action or task."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[doc = "  \"source_file\": \"entities/Intent.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct IntentEntity {
    pub components: IntentComponents,
    #[doc = "A canonical enum of all 7 cognitive entity types."]
    pub entity_type: EntityType,
    pub physics_state: IntentPhysicsState,
}
impl ::std::convert::From<&IntentEntity> for IntentEntity {
    fn from(value: &IntentEntity) -> Self {
        value.clone()
    }
}
impl IntentEntity {
    pub fn builder() -> builder::IntentEntity {
        Default::default()
    }
}
...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct IntentEntity {
        components: ::std::result::Result<super::IntentComponents, ::std::string::String>,
        entity_type: ::std::result::Result<super::EntityType, ::std::string::String>,
        physics_state: ::std::result::Result<super::IntentPhysicsState, ::std::string::String>,
    }
    impl ::std::default::Default for IntentEntity {
        fn default() -> Self {
            Self {
    ...
    impl IntentEntity {
        ...
        where
            T: ::std::convert::TryInto<super::IntentComponents>,
            T::Error: ::std::fmt::Display,
        {
        ...
        where
            T: ::std::convert::TryInto<super::IntentPhysicsState>,
            T::Error: ::std::fmt::Display,
        {
    ...
    impl ::std::convert::TryFrom<IntentEntity> for super::IntentEntity {
        type Error = super::error::ConversionError;
        fn try_from(
            value: IntentEntity,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::IntentEntity> for IntentEntity {
        fn from(value: super::IntentEntity) -> Self {
            Self {
