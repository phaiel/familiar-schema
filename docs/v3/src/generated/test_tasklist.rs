...
#[doc = "  \"source_file\": \"snippets/types/primitives/TaskList.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
#[serde(transparent)]
pub struct TaskList(pub ::std::vec::Vec<TaskDefinition>);
impl ::std::ops::Deref for TaskList {
    type Target = ::std::vec::Vec<TaskDefinition>;
    fn deref(&self) -> &::std::vec::Vec<TaskDefinition> {
        &self.0
    }
}
impl ::std::convert::From<TaskList> for ::std::vec::Vec<TaskDefinition> {
...
impl ::std::convert::From<::std::vec::Vec<TaskDefinition>> for TaskList {
    fn from(value: ::std::vec::Vec<TaskDefinition>) -> Self {
        Self(value)
    }
}
