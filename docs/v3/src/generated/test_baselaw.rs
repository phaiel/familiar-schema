...
#[doc = "The base schema for all physics laws, defining the execution envelope and affected components."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"$id\": \"https://familiar.dev/schemas/base/Law.v1.schema.json\","]
#[doc = "  \"title\": \"Base Physics Law\","]
#[doc = "  \"description\": \"The base schema for all physics laws, defining the execution envelope and affected components.\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
...
#[doc = "  },"]
#[doc = "  \"category\": \"_base\","]
#[doc = "  \"source_file\": \"_base/BaseLaw.schema.json\""]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct BasePhysicsLaw {
...
impl ::std::convert::From<&BasePhysicsLaw> for BasePhysicsLaw {
    fn from(value: &BasePhysicsLaw) -> Self {
        value.clone()
    }
}
impl BasePhysicsLaw {
    pub fn builder() -> builder::BasePhysicsLaw {
        Default::default()
    }
}
...
pub mod builder {
    ...
    impl ::std::default::Default for BasePhysicsLaw {
        fn default() -> Self {
            Self {
    ...
    impl ::std::convert::TryFrom<BasePhysicsLaw> for super::BasePhysicsLaw {
        type Error = super::error::ConversionError;
        fn try_from(
            value: BasePhysicsLaw,
    ...
    impl ::std::convert::From<super::BasePhysicsLaw> for BasePhysicsLaw {
        fn from(value: super::BasePhysicsLaw) -> Self {
            Self {
