...
pub struct ThreadStateLogColumns {
    ...
    pub metadata: ::std::collections::HashMap<
        ::std::string::String,
        ::std::collections::HashMap<::std::string::String, ThreadStateLogColumnsMetadataValueValue>,
    >,
...
#[doc = "`ThreadStateLogColumnsMetadataValueValue`"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
#[serde(untagged)]
pub enum ThreadStateLogColumnsMetadataValueValue {
    Variant0(::std::string::String),
    Variant1(f64),
    Variant2(bool),
}
impl ::std::convert::From<&Self> for ThreadStateLogColumnsMetadataValueValue {
    fn from(value: &ThreadStateLogColumnsMetadataValueValue) -> Self {
        value.clone()
    }
}
impl ::std::str::FromStr for ThreadStateLogColumnsMetadataValueValue {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for ThreadStateLogColumnsMetadataValueValue {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for ThreadStateLogColumnsMetadataValueValue {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::fmt::Display for ThreadStateLogColumnsMetadataValueValue {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
...
impl ::std::convert::From<f64> for ThreadStateLogColumnsMetadataValueValue {
    fn from(value: f64) -> Self {
        Self::Variant1(value)
    }
}
impl ::std::convert::From<bool> for ThreadStateLogColumnsMetadataValueValue {
    ...
    pub struct ThreadStateLogColumns {
        ...
        metadata: ::std::result::Result<
            ::std::collections::HashMap<
                ...
                ::std::collections::HashMap<
                    ::std::string::String,
                    super::ThreadStateLogColumnsMetadataValueValue,
                >,
            >,
            ::std::string::String,
        >,
